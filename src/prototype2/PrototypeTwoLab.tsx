...
const topicSpec = {
  ...
  essentialQuestion: "What makes current flow, and how does resistance change it?",
};
...
export function PrototypeTwoLab() {
  ...
  function chooseDepth(nextTimeChoice: TimeChoice) {
    ...
    setSetupTransitioning(true);
    window.setTimeout(() => buildLearningPath(), 320);
  }
  ...
  return (
    <div className={`lesson-page stage-enter${result ? " lesson-ready" : ""}`}>
