...
type Stage = "discover" | "setup" | "textbook" | "lesson";
type SetupStep = "intent" | "depth";
type Goal = P3Goal;
type TimeChoice = P3Depth;
type FieldId =
  | "space"
  | "electricity"
  | "mathematics"
...
export function PrototypeThreeLab() {
      ...
      >
        <header className="site-header">
          ...
          <div className="header-note">
            ...
            Static lesson → AI-composed path
          </div>
        </header>
          ...
          <section id="knowledge-eye" className="curiosity-field" aria-labelledby="curiosity-heading">
            ...
            <div className="curiosity-core">
              ...
              <span className="prototype-hint">
                <i aria-hidden="true" /> Electric circuits · local AI composition prototype
              </span>
            </div>
  ...
  const goalLabel = goalOptions.find((item) => item.id === goal)?.label ?? "I need to understand this";
  const depthLabel = timeOptions.find((item) => item.value === timeChoice)?.label ?? "Learn it";
  ...
  return (
    <div className="lesson-page stage-enter lesson-ready">
